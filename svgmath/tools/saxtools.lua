...
handler.ContentHandler-- Clone of xml.sax.saxutils.XMLGenerator, with bugs fixed.
...
handler.ContentHandler-- Implementation of ContentHandler that passes callbacks to another ContentHandler.
